...
@Slf4j
@RegisterHandler(protocol = VhProtocol.HTTP, method = VhHttpMethod.GET, endpoint = "/users/ref/available")
public class GetReferralRewardAvailableHandler extends AbstractHandler<ReferralRewardDto> {
    ...
    protected CompletionStage<BefHttpResponse<ReferralRewardDto>> doHandle(VhHttpRequest request) {
        ...
        return referralEarningRepository.getReferralRewardAvailable(wallet)
