...
@Slf4j
@RegisterHandler(protocol = VhProtocol.HTTP, method = VhHttpMethod.PUT, endpoint = "/users/information")
public class SaveUsernameAndAvatarIdHandler extends AbstractHandler<UserProfile> {
    ...
    protected CompletionStage<BefHttpResponse<UserProfile>> doHandle(VhHttpRequest request) {
        ...
        return userRepository.updateUsernameAndAvatarId(updateUserProfile)
